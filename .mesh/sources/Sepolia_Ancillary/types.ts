...
export type Sep_AgreementEligibility = {
  id: Scalars['ID']['output'];
...
export type Sep_AllowListEligibility = {
  id: Scalars['ID']['output'];
  hatId: Scalars['String']['output'];
  ownerHat: Sep_HatAuthority;
  arbitratorHat: Sep_HatAuthority;
...
export type Sep_CharacterSheetsLevelEligibility = {
  id: Scalars['ID']['output'];
  hatId: Scalars['String']['output'];
...
export type Sep_HatsElectionEligibility = {
  id: Scalars['ID']['output'];
  hatId: Scalars['String']['output'];
...
export type Sep_JokeRaceEligibility = {
  id: Scalars['ID']['output'];
  hatId: Scalars['String']['output'];
  adminHat: Array<Sep_HatAuthority>;
...
export type Sep_PassthroughModule = {
  id: Scalars['ID']['output'];
  hatId: Scalars['String']['output'];
...
export type Sep_StakingEligibility = {
  id: Scalars['ID']['output'];
  hatId: Scalars['String']['output'];
